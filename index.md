...
- composable HTML templates (parameters, content injection, and
  fragments)
- template caching
- weak ETag caching
...
> Attribute names with non-leading underscores are rewritten to
> hyphenated HTML attributes. Trailing underscores are removed. Double
